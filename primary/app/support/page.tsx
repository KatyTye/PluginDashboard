		...
		<div className="grid mt-10 mb-10 lg:grid-cols-[2.06fr_1fr] gap-10 justify-center">
			<div className="w-full bg-(--box-background-color) border-(--border-color) p-5 border-2 rounded-2xl">
				...
				<p className="mt-2 text-(--text-second-color) tracking-widest">
					If you have any general questions about how to do things, please check the <Link href={"/docs"}
			...
			<div className="w-full bg-(--box-background-color) border-(--border-color) p-5 border-2 rounded-2xl">
				...
				<p className="mt-2 text-(--text-second-color) tracking-widest">
					You can contact us for support at our email: <a href="mailto:support.sessentials@gmail.com"
						className="text-(--special-color) hover:text-amber-700" rel="noopener noreferrer">
						support.sessentials@gmail.com</a>. Please note that it may take several days to receive a response.
				</p>
			</div>
		</div>
