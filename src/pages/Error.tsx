...
export default function ErrorPage() {
	...
	return (<>
		...
		<main className="page-content flex flex-col p-4 md:p-20 pt-10 pb-10">
			<div className="m-auto mt-10 mb-3 full-image p-2 bg-(--background-color) w-2/3 max-w-50 shadow-red-400">
			...
			border-(--border-color) border-2 p-3 rounded-lg mb-10 max-w-250 self-center">
